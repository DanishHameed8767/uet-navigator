...
export default function MapCanvas() {
    ...
    return (
        <div className="w-full h-screen bg-slate-900 flex flex-col">
            {/* Top control bar */}
            <div className="z-1 flex items-center gap-4 bg-slate-800 text-slate-100 px-4 py-2 text-sm shadow">
                <span>
                    Start:{" "}
                    <span className="font-mono">
                        {startNode ?? "click map to set"}
                    </span>
                </span>
                <span>
                    End:{" "}
                    <span className="font-mono">
                        {endNode ?? "click again to set"}
                    </span>
                </span>
                <button
                ...
                >
                    ...
                    <Layer>
                        {osm.ways.map((way) => {
                            ...
                            const isFoot =
                                way.type === "footway" || way.type === "path";
